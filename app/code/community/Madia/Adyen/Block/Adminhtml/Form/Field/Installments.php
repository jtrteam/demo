 ...
 * DISCLAIMER
 *
 * Madia_Adyen_Block_Adminhtml_Form_Field_Installments 	
 * is based on 
 ...
 */
class Madia_Adyen_Block_Adminhtml_Form_Field_Installments extends Mage_Adminhtml_Block_System_Config_Form_Field_Array_Abstract
{
    ...
    protected function _prepareToRender()
    {
        ...
        $this->addColumn('installment_boundary', array(
            'label' => Mage::helper('adyen')->__('Boundary Amount (incl.)'),
            'style' => 'width:100px',
        ));
