 ...
 */
class Fisheye_Adwords_Block_Block extends Mage_Core_Block_Abstract
{
	...
	protected function _toHtml()
   {
   	...
   	if(Mage::helper('fisheye_adwords')->isTrackingAllowed()){
   		
   	$this->setAmount(Mage::helper('fisheye_adwords')->getOrderTotal());
   	$html .= '
